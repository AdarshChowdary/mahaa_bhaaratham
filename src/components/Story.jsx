  ...
  return (
    <div id="today_story" className="w-full max-h-fit flex flex-col items-center justify-center gap-5 py-10 bg-[#1b4965]">
        ...
        <div className="flex flex-col text-[#62b6cb] text-lg font-extralight w-[75%] m-auto text-justify">
            <p>
                The generation of Devas, in brief, was thirty-three thousand, thirty-three hundred and thirty-three. The sons of Div were Brihadbhanu, Chakshus, Atma Vibhavasu, Savita, Richika, Arka, Bhanu, Asavaha, and Ravi. Of these Vivaswans of old, Mahya was the youngest whose son was Deva-vrata. The latter had for his son, Su-vrata who, we learn, had three sons,—Dasa-jyoti, Sata-jyoti, and Sahasra-jyoti, each of them producing numerous offspring. 
            </p>
            <br />
            <p>
                The illustrious Dasa-jyoti had ten thousand, Sata-jyoti ten times that number, and Sahasra-jyoti ten times the number of Sata-jyoti’s offspring. From these are descended the family of the Kurus, of the Yadus, and of Bharata; the family of Yayati and of Ikshwaku; also of all the Rajarshis. Numerous also were the generations produced, and very abundant were the creatures and their places of abode. The mystery which is threefold—the Vedas, Yoga, and Vijnana Dharma, Artha, and Kama—also various books upon the subject of Dharma, Artha, and Kama; also rules for the conduct of mankind; also histories and discourses with various srutis; all of which having been seen by the Rishi Vyasa are here in due order mentioned as a specimen of the book.
            </p>
            <br />
            <p>
